...
*				16.9.2011
*				Izboljšana funkcionalnos performPayment() v delu ko se preverja
*				odgovor na poslan POST message 'performPayment'
*				24.10.2011
*				Dodana funkcionalnost sprejemanja in zapis ECI vrednosti v podatkovno bazo
...
class e24PaymentPipe
{
    ...
    function performPaymentInitialization()
    {
        ...
        $secResource = new SecureResource();
    ...
    // (CAPTURE, VOID AUTHORIZATION) in ga poslje placilnemu strezniku preko POST metode.
    function performPayment()
    {
        ...
        // Odgovor placilnega serverja razparsamo.
		//MK Preverba odgovora
		if(strpos($this->rawResponse,"ERROR"))
		{
